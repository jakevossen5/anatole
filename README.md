NOTICE: This is just a fork of the [anatole](https://github.com/lxndrblz/anatole/) theme, use that repo for up to date fixes / patches.
This fork contains some changes I made for my personal site.
